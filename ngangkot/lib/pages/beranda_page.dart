            ...
            Padding(
              ...
              child: TextField(
                decoration: InputDecoration(
                  hintText: 'Cari rute, stasiun, atau berita...',
                  prefixIcon:
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: const [
                  RouteCard(
                    code: 'FD-1',
                    name: 'Simpang Soetta Ki...',
                    color: AppColors.routeGreen,
                  ),
                  RouteCard(
                    code: 'K3',
                    name: 'Bandung Electroni...',
...
class GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ..moveTo(40, 60)
      ..quadraticBezierTo(size.width / 2, 80, size.width - 60, 100)
